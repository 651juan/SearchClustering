...
require.define("/distance.js", function (require, module, exports, __dirname, __filename) {
  ...
  euclidean: function(v1, v2) {
      var total = 0;
	  //-->Modified here to skip first value when calculating distance
...
//--->Shuffles the vectors and returns the first k vectors to be used as the centroids
...
//--->calculates distance between vector and each centroid and returns te index of the closest centroid
